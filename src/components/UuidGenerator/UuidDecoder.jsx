  ...
  return (
    <div className="w-100">
      <div className="md:flex md:gap-3 items-center">
        <input
          type="text"
          className="h-20 md:h-11 w-full md:w-2/4 p-4 rounded-sm"
        ...
        <button
          onClick={decodeUUID}
          className="bg-primary-500 mt-4 md:mt-0 h-10 text-center px-3 rounded-md hover:bg-primary-800 hover:shadow-md text-white"
        >
          Decode UUID
        </button>
      </div>
